...
#define EA_VERSION "v51-H1CUTSAFE"
...
int PNL_PX = 12, PNL_PY = 18, PNL_W = 310, PNL_H = 830;
...
void UpdatePanel()
{
   ...
   PnlRow(x0, y, contentW, "M5  (Entry)",   g_scalpEntryDir,  DirColor(g_scalpEntryDir));  y += 16;
   ...
   //--- Win Rate & Trade Stats (Added for Replay & Live Validation) ---
   RecalcStatsIfNeeded();
   ...
   PnlRow(x0, y, contentW, "Closed Profit", StringFormat("%+.2f  (%d trades)", g_statTotalProfit, g_statTrades), g_statTotalProfit >= 0 ? PNL_EMERALD : PNL_ROSE); y += 18;
