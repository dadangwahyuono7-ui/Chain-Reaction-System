...
# Paksa stdout/stderr UTF-8 — cegah crash UnicodeEncodeError (✓/⚠) di console non-UTF8
# (cmd legacy / output redirect). Aman di semua konteks, TIDAK ubah tampilan dashboard.
import sys
try:
