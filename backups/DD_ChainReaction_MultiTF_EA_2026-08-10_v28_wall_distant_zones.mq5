...
#define WALL_SLOTS_PER_SIDE 6   // v28: keep in sync with WALL_SLOTS_PER_SIDE in udp_listener.py's write_mt5_bridge_file()
...
void ReadBookmapBridge()
{
   ...
   int totalFields = 5 + WALL_SLOTS_PER_SIDE * 2 * 2;   // timestamp,price,cvd,pulse,absorption + (bid+ask)*(px+sz) per slot
