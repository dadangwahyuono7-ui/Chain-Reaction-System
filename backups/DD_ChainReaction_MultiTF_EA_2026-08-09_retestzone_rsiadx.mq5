...
input group "=== RSI / ADX FILTER (eksperimen, default OFF - di luar doktrin CMP murni) ==="
input bool                InpUseADX         = false;    // Filter momentum ADX (skip entry kalau ADX < InpADX_MinLevel)
