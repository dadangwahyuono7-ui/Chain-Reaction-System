...
//| two-font system (Segoe UI for labels/headers, Lucida Console      |
//| monospace for right-aligned numbers, bold simulated via 4x offset |
//| glyph stamping since Canvas.mqh has no reliable weight flag).     |
//+------------------------------------------------------------------+
...
#define PNL_FONT_NUM "Lucida Console"  // right-aligned numeric values (monospace)
