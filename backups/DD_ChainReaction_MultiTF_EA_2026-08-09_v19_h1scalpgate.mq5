...
input group "=== H1 GATE BUAT SCALP (Dadang 2026-08-09: 'jangan cari sell jika H4 BO buy tapi H1 masih posisi BO buy, cari sell ketika H1 sudah CMP sell - selama Master gak berubah dia akan tetap ke arah itu') ==="
input bool                InpRequireH1ForScalp = true;   // Wajib H1 CMP JUGA udah searah sebelum berani SCALP (lawan H4) - gak berlaku pas searah H4
