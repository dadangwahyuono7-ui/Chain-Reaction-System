...
// v39.6: settled via a 6-way A/B test in DD_PanelPreview.mq5 (options
// A-F, same sample string) - Dadang picked "E": a black outline stamped
// in all 8 directions around the glyph, THEN the real color filled on
// top. This is what actually reads as solid - not more font-weight
// guessing, an outline/silhouette technique that works regardless of
// whether the weight flag does anything on this system.
