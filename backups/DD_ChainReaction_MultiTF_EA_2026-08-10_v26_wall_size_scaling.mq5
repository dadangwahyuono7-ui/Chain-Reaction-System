...
void DrawWallLine(string key, double bookmapPrice, double size, double offset, bool isBid, string sideLabel)
{
   ...
   ObjectSetInteger(0, textName, OBJPROP_FONTSIZE, 8 + (width - 1));   // bigger wall = bigger text too
...
void UpdateWallLines()
{
   ...
   DrawWallLine("BID1", g_bookmapBid1Px, g_bookmapBid1Sz, offset, true,  "BID WALL 1");
   DrawWallLine("BID2", g_bookmapBid2Px, g_bookmapBid2Sz, offset, true,  "BID WALL 2");
   DrawWallLine("ASK1", g_bookmapAsk1Px, g_bookmapAsk1Sz, offset, false, "ASK WALL 1");
   DrawWallLine("ASK2", g_bookmapAsk2Px, g_bookmapAsk2Sz, offset, false, "ASK WALL 2");
}
