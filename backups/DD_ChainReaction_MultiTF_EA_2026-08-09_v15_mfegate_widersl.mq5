...
input double              InpTrailStartPips= 40;             // Trailing mulai aktif setelah profit sekian pip - retuned 2026-08-09 dari MFE/MAE analysis (lihat InpBE_TriggerPips)
input double              InpTrailStepPips = 30;             // Jarak trailing dari harga sekarang (pip) - retuned 2026-08-09
input bool                InpUseBreakEven = true;           // Aktifkan break-even NORMAL
input double              InpBE_TriggerPips= 15;             // BE aktif setelah profit sekian pip - retuned 2026-08-09: MFE analysis atas 283 trade v14 nunjukin 90% trade yang "sempet menang tapi akhirnya kalah" udah nyampe minimal ~14pip - kunci di situ nyelametin sebagian besar
