...
int OnInit()
{
   ...
   if(InpAvoidBigSNR)
   {
      ...
      if(g_hWeekly == INVALID_HANDLE || g_hDaily == INVALID_HANDLE || g_hH1 == INVALID_HANDLE)
         Print("WARNING: gagal load DD_CMP_Indicator buat W1/D1/H1 - filter InpAvoidBigSNR di-skip (bukan fatal).");
   }
