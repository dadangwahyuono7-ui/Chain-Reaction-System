...
input bool                InpAllowScalpEntries = false;    // Boleh BENERAN buka posisi SCALP (arah lawan Master) - Dadang: SCALP payoff konsisten jelek (0.26) di semua percobaan, dimatiin dulu sampai ketemu fix-nya, tapi infrastruktur M30 tetap jalan buat NORMAL tier
...
void TryOpen(string dir, string tag, bool isScalp)
{
   ...
   double slPipsActual = (sl > 0) ? MathAbs(px - sl) / pip : InpSL_Pips;
