...
input double              InpTP_Pips      = 100;             // Take Profit NORMAL (pips, 0 = tanpa TP) - verified 2026-08-09 full-year backtest
...
input double              InpTrailStepPips = 50;             // Jarak trailing dari harga sekarang (pip)
input bool                InpUseBreakEven = true;           // Aktifkan break-even NORMAL
input double              InpBE_TriggerPips= 20;             // BE aktif setelah profit sekian pip
