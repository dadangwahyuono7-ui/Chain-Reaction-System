...
input double              InpBE_TriggerPips= 20;             // BE aktif setelah profit sekian pip - dilonggarin dari 4 (Dadang: "terlalu cepat geser BE, gak sehat")
...
input double              InpBarrierBE_MinProfitPips = 10;   // Minimal profit dulu sebelum barrier-BE boleh aktif - cegah BE nyangkut instan kalau entry udah deket barrier dari awal
