...
class CVDEngine:
    ...
    def get_display_cvd(self) -> float:
        """THE CVD number - rolling CVD_DISPLAY_WINDOW_SEC window, matches
        Dadang's live Bookmap widget. Single source of truth so panel/
        dashboard/chart-indicator all read the same thing - see module
        docstring."""
        return self.get_window_delta(CVD_DISPLAY_WINDOW_SEC)
